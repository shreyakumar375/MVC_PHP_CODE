	...
	<form>
		...
		<div class="">
			<div id="myDropdown" class="dropdown-content-header">
				...
				<p>
				<a href="#" style="color: blue !important; float: right;margin-right: 41px;font-size: 13px;margin-top: -2px;margin-left: -7px;" id="headerlogout"><?php echo ''.$_SESSION['email'];?></a>
				</p>

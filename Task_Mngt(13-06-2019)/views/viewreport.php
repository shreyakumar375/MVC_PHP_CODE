...
<head>
	...
	<style type="text/css">
		...
		.create-button{margin-top:67px !important;}
		.btn
		{
			margin-right: 10px;
			font-size: 10px;
...
<body>
	...
	<form>
		...
		<div style="" class="color"><h3>Details of all users<a href="?rt=index/samepage" class="back-div"><img src="../Task_Mngt/images/Backicon.png" title="Back" alt="arrow" height="50px" width="50px"></a></h3></div>

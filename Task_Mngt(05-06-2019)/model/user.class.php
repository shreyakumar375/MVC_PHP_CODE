...
class user
{
    ...
    public function getFeatureDetailsByRole($db,$role_id)
    {
        ...
        $sql="SELECT t1.TM_feature_id, t1.TM_feature_name, t3.Tm_Role_id FROM TM_feature_info as t1,TM_role_map_feature as t2,TM_role_info as t3 WHERE t1.TM_feature_id = t2.TM_role_map_feature_id AND t3.TM_role_id = $role_id AND t2.TM_role_map_feature_isActive = 1 AND t1.TM_feature_menu_flag = 1 ";
                ...
                foreach ($result as $key => $value) {
                    ...
                    $sql1="SELECT t1.TM_feature_id, t1.TM_feature_name, t3.Tm_Role_id FROM TM_feature_info as t1,TM_role_map_feature as t2,TM_role_info as t3 WHERE t1.TM_feature_id = t2.TM_feature_id AND t3.TM_role_id = $role_id AND t2.TM_role_map_feature_isActive = 1 AND t1.TM_feature_menu_flag = 0 and t1.TM_feature_parent_id ='".$value['TM_feature_id']."' ";
    ...
    public function getFeatureDetailslist($db)
    {
        ...
        $sql="SELECT t1.TM_feature_id, t1.TM_feature_name, t3.Tm_Role_id FROM TM_feature_info as t1,TM_role_map_feature as t2,TM_role_info as t3 WHERE t1.TM_feature_id = t2.TM_role_map_feature_id AND t3.TM_role_id = t2.Tm_Role_id AND t2.TM_role_map_feature_isActive = 1 AND t1.TM_feature_menu_flag = 1 ";
                $result = $db->query($sql)->fetchAll(PDO::FETCH_ASSOC);
                //print_r( $result); exit();
                foreach ($result as $key => $value) {

                    $sql1="SELECT t1.TM_feature_id, t1.TM_feature_name, t3.Tm_Role_id FROM TM_feature_info as t1,TM_role_map_feature as t2,TM_role_info as t3 WHERE t1.TM_feature_id = t2.TM_feature_id AND t3.TM_role_id = t2.Tm_Role_id AND t2.TM_role_map_feature_isActive = 1 AND t1.TM_feature_menu_flag = 0 and t1.TM_feature_parent_id ='".$value['TM_feature_id']."' ";
                    $result1 = $db->query($sql1)->fetchAll(PDO::FETCH_ASSOC);
                    $result[$key]['subfeature']= $result1;
                }
                //print_r( $result); exit();

...
class user
{
	...
	public function fCreateNewUser($db,$login_id,$username,$password,$Email,$Creationdate,$Creationdate_time){
		...
		if(count($result)>0){
			...
			$sql1 ="INSERT INTO  TM_user_info SET TM_info_login_id='$login_id',TM_info_user_name ='$username',TM_info_user_pass='$password',TM_info_user_emailid='$Email',TM_info_user_created_date='$Creationdate',TM_info_user_created_date_time='$Creationdate_time' ";
			//echo $sql; exit;
			$db->query($sql1);
	...
	public function getDetails($db,$flag)
            {
                $stmt = "SELECT TM_info_user_id AS id,TM_info_login_id, TM_info_user_name, TM_info_user_pass,TM_info_user_emailid,TM_info_user_created_date,TM_info_user_created_date_time FROM TM_user_info where TM_info_user_name!='' AND TM_info_user_isActive = '$flag' "; 

     ...
     public function fCreateNewUser($db,$login_id,$username,$password,$Email,$Creationdate,$Creationdate_time)
     {
          ...
          if(count($result)>0)
          {
           ...
           exit;
            ...
            {
               $sql1 ="INSERT INTO  TM_user_info SET TM_info_login_id='$login_id',TM_info_user_name ='$username',TM_info_user_pass= MD5('$password'),TM_info_user_emailid='$Email',TM_info_user_created_date='$Creationdate',TM_info_user_created_date_time='$Creationdate_time',TM_info_user_isActive='1' ";
